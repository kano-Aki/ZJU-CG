...
int main()
{
    ...
    unsigned char *data = stbi_load("C:/D/ZJU/learn/31/cg/lab/src/learn/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("C:/D/ZJU/learn/31/cg/lab/src/learn/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
